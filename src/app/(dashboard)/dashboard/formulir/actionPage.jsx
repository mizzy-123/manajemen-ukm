              ...
              <div className="components-preview wide-md mx-auto">
                <div className="nk-block-head nk-block-head-lg wide-sm">
                  <div className="nk-block-head-content">
                    ...
                    <h2 className="nk-block-title fw-normal">Perekrutan ukm dan calon anggota</h2>
                ...
                <div className="nk-block nk-block-lg">
                  <div className="nk-block-head d-flex justify-content-between">
                    <div className="nk-block-head-content">
                      <h4 className="nk-block-title">Formulir pendaftaran</h4>
                      <p>{/* The following table can be use for <strong className="text-primary">invoice, payment history</strong> related transaction. */}</p>
                    </div>
